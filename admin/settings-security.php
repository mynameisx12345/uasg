...
<head>
  ...
  <style>
    body { background: transparent; padding: 24px; margin: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; }
    ...
    .sec-input-wrap input{width:100%;padding:10px 40px 10px 14px;border:1px solid #e2e8f0;border-radius:8px;font-size:13px;transition:border-color .2s;box-sizing:border-box;}
...
$('#changePasswordBtn').on('click',function(){
  ...
  $.post('ajax.php',{CALL:58,current_password:cur,new_password:np},function(r){
    if(r.status==='SUCCESS'){
