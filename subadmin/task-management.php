        ...
        columns: [
            ...
            { 
                ...
                render: function(data, type, row) {
                    ...
                    // Edit button (always available for active tasks with permission)
                    ...
                    if (isOverdue && row.assigned_to) {
                        actions.push(`<button class="dropdown-item transferTaskBtn" style="color: #ff9800;" data-id="${row.task_id}" data-title="${row.task_title}">
                            <i class="fas fa-exchange-alt"></i> Transfer
                        </button>`);
                    }
                    
                    // Close button (mark as closed/completed)
                    actions.push(`<button class="dropdown-item closeTaskBtn" style="color: #28a745;" data-id="${row.task_id}" data-title="${row.task_title}" data-action="close">
                        <i class="fas fa-check-circle"></i> Close Task
                    </button>`);
                    
                    // Cancel button (mark as cancelled)
                    actions.push(`<button class="dropdown-item cancelTaskBtn" style="color: #ffc107;" data-id="${row.task_id}" data-title="${row.task_title}" data-action="cancel">
