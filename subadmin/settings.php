...
<body>
  ...
  $('#changePasswordBtn').on('click',function(){
    ...
    $.ajax({
      ...
      data:{CALL:3,DATA:{current_password:cur,new_password:np,confirm_password:cp}},
      success:function(r){
      ...
      error:function(){showMsg('Request failed.','error');},
      complete:function(){btn.prop('disabled',false).text('Update Password');}
    });
  });
  </script>
</body>
